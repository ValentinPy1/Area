...
const TTDetailScreen: React.FC = ({ route, navigation }: any) => {
  ...
  useEffect(() => {
    ...
    const handleTriggerPress = async (trigger) => {
      ...
      await AsyncStorage.setItem('selectedActionId', trigger.id);
      if (title === "Discord") {
        Alert.alert(
          "Connect to Discord",
          ...
          <WebView 
              ...
              onNavigationStateChange={(navState) => {
                  ...
                  if (navState.url.includes("?code")) {
                      ...
                      navigation.navigate('Discord', {actionOrTrigger: "action"});
                  }
              }}
          />
      );
