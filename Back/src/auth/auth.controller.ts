 ...
 */
  @Get('cookie')
  addcooo(@Res() res) {
    res.cookie('authorization', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImhlbnJ5QGdtYWlsLmNvbSIsImlkIjoiNDZjNjliNjItZGQ3MC00OTg1LWJiZDUtMTNkN2M4ZmI4YWRlIiwiaWF0IjoxNjk5MjYzMDUyfQ.UvFiMVW9Wl3Y-owNg5Uzu8yA11C-e-3FF4-6aW_EfjA')
    return res.send("OK")
  }
}
